...
_INDEX_STATEMENTS = (
    ...
    "CREATE INDEX IF NOT EXISTS idx_security_universe_eligibility ON security_universe(eligibility_status)",
    "CREATE INDEX IF NOT EXISTS idx_security_universe_exchange ON security_universe(exchange)",
    "CREATE INDEX IF NOT EXISTS idx_security_universe_security_type ON security_universe(security_type)",
